...
## Version 0.16.16 - 2021-11-07
 - Fixed [#362](https://github.com/codeneos/vlocode/issues/362); issue with tsconfig-paths-webpack-plugin causing relative imports in modules to be incorrectly resolved to local files if they could be resolved locally
